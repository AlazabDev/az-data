...
export const dict: Dict = {
  ...
  nav_security_log: { ar: "سجل الأمان", en: "Security log" },
  security_log_desc: {
    ar: "كل أحداث المصادقة ورفع وحذف الملفات، مسجلة تلقائياً ومتاحة لمسؤولي المنصة فقط.",
    en: "Every authentication and file storage event, recorded automatically for platform admins only.",
  },
  security_log_forbidden: {
    ar: "سجل الأمان متاح لمالك المنصة والمسؤولين فقط.",
    en: "The security log is restricted to platform owners and admins.",
  },
  security_filter_all: { ar: "الكل", en: "All" },
  security_filter_auth: { ar: "المصادقة", en: "Authentication" },
  security_filter_storage: { ar: "التخزين", en: "Storage" },
  security_filter_failure: { ar: "المحاولات الفاشلة", en: "Failures" },
